...
import com.arkam.popularmovies.Model.movie_search
import com.arkam.popularmovies.Model.moviecastresopnse
import com.arkam.popularmovies.Model.movieresponse
import com.arkam.popularmovies.Model.videoresponse
...
//        setSupportActionBar(toolbar)
        ...
        imgfav.setOnClickListener {
            ...
            if(fill==1)
            {
                ...
                id?.let { it1 ->
                    service.getmovies(it1,api_key).enqueue(object : Callback<movie_search> {

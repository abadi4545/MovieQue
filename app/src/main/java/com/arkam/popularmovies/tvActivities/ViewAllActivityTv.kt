...
import com.arkam.popularmovies.model.tvresponse
import com.arkam.popularmovies.network.PopInterface
import com.arkam.popularmovies.R
import com.arkam.popularmovies.tvAdapters.ViewAllAdapterTv
...
class ViewAllActivityTv : AppCompatActivity() {
    var language = "en-US"
        ...
        fun toBeCalled() {
            ...
            if (type == "Popular") {
                        ...
                        override fun onResponse(
                            ...
                            if (i == 0) {
                                ...
                                rViewall.layoutManager =
                                    GridLayoutManager(this@ViewAllActivityTv, 2)
                                rViewall.adapter = ViewAllAdapterTv(
                                    this@ViewAllActivityTv,
                                    tvList,
                                    false
                                )
                            } else {
                ...
                if (type == "airingtoday") {
                    ...
                    service.getairingtodayall(api_key, currentPage.toString())
                        .enqueue(object : Callback<tvresponse> {
                            override fun onFailure(call: Call<tvresponse>, t: Throwable) {
                                Log.d("MoviesDagger", t.toString())
                            }
                    ...
                    if (type == "Toprated") {
                        ...
                        service.gettopratedtv(api_key, currentPage.toString())
                            .enqueue(object : Callback<tvresponse> {
                                override fun onFailure(call: Call<tvresponse>, t: Throwable) {
                                    Log.d("MoviesDagger", t.toString())
                                }
                        ...
                        if (type == "ontheair") {
                            ...
                            service.getontheair(api_key, currentPage.toString())
                                .enqueue(object : Callback<tvresponse> {
                                    override fun onFailure(call: Call<tvresponse>, t: Throwable) {
                                        Log.d("MoviesDagger", t.toString())
                                    }

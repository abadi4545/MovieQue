...
import com.arkam.popularmovies.Model.videotv
import com.arkam.popularmovies.R
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.layout_5.view.*

class videoadaptertv(val context: Context, val namelist:List<videotv>, val check:Boolean): RecyclerView.Adapter<videoadaptertv.myviewholder>() {
